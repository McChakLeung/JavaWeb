...
<head>
    ...
    <script type="text/javascript">
        $(function () {
            //1.获取answer的值
            var answer = '${requestScope.question.answer}';
            //2.遍历radio组件，查询每个radio所对应的值，如果一致，则将该radio变成checked状态
            $(":radio").each(function (index,domObj) {
                if($(domObj).val()==answer){
                        ...
                        <tr
                            ...
                            <td align="center" valign="middle"
                                ...
                                <p>
                                    ...
                                    <input type="hidden" value="${requestScope.question.id}" name="id">
                                    ...
                                    />
                                    <input name="input" value="修改" type="submit"
                                           style="background: none; border: none; width: 70px; height: 23px; background: url(/images/button.jpg) no-repeat; color: #FFFFFF; font-size: 14px;"
                                    />
                                    <br />
                                </p>
