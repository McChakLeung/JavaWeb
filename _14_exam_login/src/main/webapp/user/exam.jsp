...
<div>
    ...
    <div id="ks">
        ...
        <div class="ks_bottom">
            <div class="ti">
                <form action="/exam/user/score.do" method="get">

                    <c:forEach items="${sessionScope.questionList}" var="question" varStatus="vs">
                        <%--<input type="hidden" name="itemSize" value="8">--%>

                        <p>
                            <span style="font-weight: bold; color: #296DB8;">${vs.count}、</span> ${question.title}
                        </p>
